...
const EditarProducto = ({ loading, formData, setFormData, onSubmit, proveedores, resetForm }) => {
...
EditarProducto.propTypes = {
  ...
  proveedores: PropType.array.isRequired,
  resetForm: PropType.func.isRequired
}
